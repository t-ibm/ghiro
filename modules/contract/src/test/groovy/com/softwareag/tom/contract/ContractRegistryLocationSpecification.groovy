...
class ContractRegistryLocationSpecification extends Specification {
    ...
    def setup() {
        ...
        contractRegistry = ContractRegistry.build(new SolidityLocationFileSystem(config.node.contract.registry.location as URI), new ConfigLocationFileSystem(config.node.config.location as URI))
    }
